...
BLOG_AUTHOR = "Austin Tripp"  # (translatable)
BLOG_TITLE = "Austin Tripp's website"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://austintripp.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://austintripp.ca/"
BLOG_EMAIL = "austin.james.tripp[at]gmail.com"
BLOG_DESCRIPTION = "Austin Tripp's personal website"  # (translatable)
...
# Defaults to 10
INDEX_DISPLAY_POST_COUNT = 10_000  # ideally all posts on a single page
