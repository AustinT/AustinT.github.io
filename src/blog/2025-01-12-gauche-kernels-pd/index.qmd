...
- machine learning
- _recent-highlight
description: "A mathematical analysis of whether the fingerprint kernels in the GAUCHE library for Gaussian processes in chemistry are positive definite (PD)."
google-scholar: true
---
