...
categories:
- research papers
description: 'I recently ran an LLM deep research query about large matrices of Tanimoto
  coefficients, and one of its references was the paper "Bandwidth adjustable Tanimoto
  kernel: a smooth alternative to the G...'
---
