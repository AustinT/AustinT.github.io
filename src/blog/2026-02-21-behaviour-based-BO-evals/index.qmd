...
- opinion
- _recent-highlight
description: I think the Bayesian optimization (BO) research community needs to change
  its evaluation practices. In a previous post I explained how I think users should
  generally bring their own model to BO and...
---
