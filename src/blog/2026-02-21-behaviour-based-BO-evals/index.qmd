...
- opinion
- _recent-highlight
description: "This post argues that regret-based evaluations are insufficient for assessing Bayesian optimization algorithms when users bring their own surrogate models, because similar regret values can arise from qualitatively different algorithm behaviours."
google-scholar: true
