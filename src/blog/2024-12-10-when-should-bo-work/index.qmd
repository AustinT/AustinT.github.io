...
- speculation
- _recent-highlight
description: As much as I believe in the potential of Bayesian optimization (BO) to
  be useful for scientific discovery, after 4+ years I have seen many instances where
  BO does not work. In this post I explain a...
---
...
![2x2 grid of whether BO will work](/blog-images/2024-12-10-bo-grid.png){fig-align="center" style="max-height: 50vh;"}
