...
- opinion
- _recent-highlight
description: "The Bayesian optimization community has neglected utility functions by defaulting to u(y) = y, which encodes a specific risk/reward preference that rarely matches real users' needs."
google-scholar: true
...
effort: high
originality: high
originality-note: "Adding a utility function is of course not my original idea, but in the ML community I don't think the consequences of excluding it are appreciated at all."
---
