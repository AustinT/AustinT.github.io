...
- opinion
- _recent-highlight
description: "This post articulates a \"model-centric\" view of Bayesian optimization (BO) in which the surrogate model is treated as a user-provided input rather than an internal algorithmic component."
google-scholar: true
...
effort: high
originality: medium
originality-note: "It's re-hashing ideas that are out there but I don't think there is another paper/essay outlining a similar perspective."
---
