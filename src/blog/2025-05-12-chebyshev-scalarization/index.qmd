...
- _all-time-best
description: I've been reading about multi-objective optimization recently. Many papers
  state limitations of "linear scalarization" approaches, mainly that it might not
  be able to represent all Pareto-optimal s...
---
