...
- machine learning
- _recent-highlight
description: 'I added the NeurIPS workshops this year (not the main conference). Here
  are my takeaways. I''ll follow up with predictions for 2026 in a later post (EDIT:
  here is that post).'
---
