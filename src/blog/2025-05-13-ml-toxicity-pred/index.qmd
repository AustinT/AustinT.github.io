...
- chemistry
- research papers
description: 'I recently read a review paper by Seal et al about machine learning
  for toxicity prediction. Given the length of the paper I thought I would share my
  important takeaways. Disclaimer: not everything...'
---
...
1. **Tautomers** are molecules which readily interconvert between each other.[^tautomers]
   One form could be toxic, the other not. A
...
[^tautomers]: Example image from wikipedia: <a title="Example of tautomers. Image by Vaccinationist, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Tautomers.svg"><img width="512" alt="Tautomers" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Tautomers.svg/512px-Tautomers.svg.png?20161224141657"></a>
