...
categories:
- machine learning
description: 'I recently read this post about generative modelling in latent space
  by Sander Dieleman and agreed strongly with the following quote (copied verbatim
  except for typo correction):'
---
