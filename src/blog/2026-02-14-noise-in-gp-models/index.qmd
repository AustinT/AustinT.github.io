---
title: Clarifying noise vs model misspecification in Gaussian Process models (and
  its importance in BO)
date: 2026-02-14T23:00Z
categories:
- machine learning
- bayesian optimization
- _recent-highlight
description: "This post identifies a subtle but consequential issue in standard Gaussian process models: the noise parameter conflates genuine measurement noise with model misspecification, causing the model to underestimate epistemic uncertainty."
google-scholar: true
---
...
![](/blog-images/2026-02-14-noise-in-gp-models/gp_misspecification_comparison.png)
...
![](/blog-images/2026-02-14-noise-in-gp-models/gp_delta_solution.png)
